...
from dprox.utils.examples.optic.common import (build_doe_model, DOEModelConfig, load_sample_img, Dataset, plot, subplot)
...
def main(args):
    ...
    # --------------- Define Optics Model ------------------- #
    doe_config = DOEModelConfig()
    rgb_collim_model = build_doe_model(doe_config).to(device)
    circular = doe_config.circular
...
def parse_args():
    ...
    parser.add_argument('--savedir', type=str, default='new_saved/train_deconv/')
