...
class DGUNet(nn.Module):
    ...
    def forward(self, img):
        ...
        ##-------------------------------------------
        ## GDM
        # stage0_img = self.model_restoration(img)
        stage0_img = img
        
        phixsy_1 = self.phi_0(stage0_img) - img
        x1_img = stage0_img - self.r0*self.phit_0(phixsy_1)
        # PMM
        ...
        stage6_img = self.model_restoration(img)
