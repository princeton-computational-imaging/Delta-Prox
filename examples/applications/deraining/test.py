...
from DGUNet_plus_conv import DGUNet
...
parser.add_argument('--result_dir', default='./results/DGUNet_plus_conv/', type=str, help='Directory for results')
parser.add_argument('--weights', default='checkpoints/DGUNet_plus_conv/model_best.pth', type=str, help='Path to weights')
