...
We cam solve this problem in ∇-Prox with the following code: 
...
To reconstruct the target image $x$ from noise-contaminated measurements $y$, we minimize the sum of a data-fidelity $f$ and a regularizer term $r$ as
